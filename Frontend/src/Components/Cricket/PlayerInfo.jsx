...
const PlayerInfo = () => {
	...
	return (
		<>
			<Row className="my-3">
				<Col lg={3}>
					...
					<div className="">
						...
						<div>
							<div
								className={`text-center uppercase font-semibold text-xl ${
						...
						<div>
							...
							<Table
								...
								hover
								responsive
								className={theme === "dark" ? "table-theme-dark" : "table-theme-light"}
							>
								<tbody>
									{playerData?.info?.DoB && (
										<tr>
				...
				<Col lg={9}>
					<div
						className={`mb-3 text-center uppercase font-semibold text-2xl ${theme === "dark" ? "text-gray-300" : ""}`}
					>
						Batting Career Summary
					</div>
					<Table borderless hover responsive className={theme === "dark" ? "table-theme-dark" : "table-theme-light"}>
						<thead>
							<tr>
					...
					<Table borderless hover className={theme === "dark" ? "table-theme-dark" : "table-theme-light"} responsive>
						<thead>
							<tr>
								<th className="sticky-col p-2 border-b text-center z-0">Format</th>
			...
			<div className={`mb-3 text-center uppercase font-semibold text-2xl ${theme === "dark" ? "text-gray-300" : ""}`}>
				Player Bio
			</div>
			<div
				className={`mt-3 ${theme === "dark" ? "text-[#f5deb3]" : "text-gray-800"}`}
